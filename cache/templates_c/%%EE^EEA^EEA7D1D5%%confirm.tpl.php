<?php /* Smarty version 2.6.26, created on 2015-12-01 11:02:36
         compiled from /home/illumin/public_html/storage/customize/view/email/en/newsletter/confirm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'config', '/home/illumin/public_html/storage/customize/view/email/en/newsletter/confirm.tpl', 1, false),array('function', 'link', '/home/illumin/public_html/storage/customize/view/email/en/newsletter/confirm.tpl', 29, false),)), $this); ?>
Thank you for shopping at <?php echo ((is_array($_tmp='STORE_NAME')) ? $this->_run_mod_handler('config', true, $_tmp) : $this->_plugins['modifier']['config'][0][0]->config($_tmp)); ?>
!
...
<a href="<?php echo smarty_function_link(array('controller' => 'newsletter','action' => 'unsubscribe','query' => "email=".($this->_tpl_vars['email']),'url' => true), $this);?>
">Unsubscribe</a>
