...
*/
	...
	protected function validateOrder(CustomerOrder $order, $step = 0)
	{
		...
		$isOrderable = isset($GLOBALS['isOrderable']) ? $GLOBALS['isOrderable'] : $order->isOrderable(true, false);
		...
		$cacheKey = 'isOrderable_' . $step;
		$isOrderable = isset($GLOBALS[$cacheKey]) ? $GLOBALS[$cacheKey] : $order->isOrderable(true, $validateFields);
		$GLOBALS[$cacheKey] = $isOrderable;
