...
class OnePageCheckoutController extends CheckoutController
{
	...
	public function shippingMethods()
	{
		...
		foreach ($this->order->getShipments() as $shipment)
		{
			...
			$shipment->shippingAddress->set($this->order->shippingAddress->get());
		}

		$response = $this->shipping();

		//var_dump($response->get());exit;
	...
	public function overview()
	{
		...
		$response = $this->postProcessResponse(new ActionResponse('order', $array));
