...
$routes = array(
					...
					// category URLs
					array(":cathandle-:id", array('controller' => 'category', 'action' => 'index'), array("cathandle" => $handle, "id" => "[0-9]+")),
					array(":cathandle-:id/:page", array('controller' => 'category', 'action' => 'index'), array("cathandle" => $handle, "id" => "[0-9]+","page" => "[0-9_]+")),

					array(":cathandle-:id/:filters", array('controller' => 'category', 'action' => 'index'), array("cathandle" => $handle, "id" => "[0-9]+", "filters" => "([,]{0,1}[^,\047]+\-[vmps]{0,1}[0-9]{0,})*")),
					array(":cathandle-:id/:filters/:page", array('controller' => 'category', 'action' => 'index'), array("cathandle" => $handle, "id" => "[0-9]+","page" => "[0-9_]+", "filters" => "[^\047]+?")),
