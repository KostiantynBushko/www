...
<div class="order">
	...
	<div class="orderingControls">
		...
		{if 'ENABLE_WISHLISTS'|config}
			<a href="{link controller=order action=addToWishList id=$product.ID returnPath=true}" rel="nofollow" class="addToWishList tooltip" title="Add To Wishlist"><span title="More"><img src="upload/theme/IlluminataMainVersion/wishicon.png"></span></a>
		{/if}
	</div>
</div>
