...
<input type="submit" class="submit" style="position: relative; right: 29px; border: none; background-image: url('upload/theme/IlluminataMainVersion/searchicon.jpg'); background-position: right; background-repeat: no-repeat; background-color: white; color: gray;" value="|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" />
