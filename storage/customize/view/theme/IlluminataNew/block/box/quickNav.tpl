...
<div class="box" style="border-left: 1px solid #ebebeb; border-right: 1px solid #ebebeb;">
	<div class="title">
	...
	<div class="content">
		...
		{*if $categories}
			<p>
				<select onchange="window.location.href = this.value;" style="width: 100%; color: #5c318c; background-color: white; font-size: 12px;margin-bottom:20px;">
