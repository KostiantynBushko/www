...
<div class="slider">
			<ul class="slides">
				<li class="slide">
				<div style="background-image: url(upload/theme/HornEyewear/banner3.jpg);">
<h1>Genuine Horn Eyeglasses</h1>
<em>Optical tradition revived</em>
<a href="">Learn more</a>
</div>
</li><li class="slide">
				<div style="background-image: url(upload/theme/HornEyewear/banner4.jpg);">
<h1>Authentic Tibetian Horn</h1>
<em>Optical tradition revived</em>
<a href="">Learn more</a>
</div>
</li><li class="slide"> 
<div style="background-image: url(upload/theme/HornEyewear/004.jpg);">
<h1>Be closer to nature</h1>
<em>Buffalo horn from Tibet</em>
<a href="">Shop online or in store</a>
</div>
</li><li class="slide">
<div style="background-image: url(upload/theme/HornEyewear/banner2.jpg);">
