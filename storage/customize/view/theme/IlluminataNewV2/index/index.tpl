...
<script src="upload/theme/IlluminataNewV2/jquery.min.js"></script>
<script src="upload/theme/IlluminataNewV2/jquery.bxslider.js"></script>
<div class="index">

{include file="layout/frontend/layout.tpl"}
<div class="row">
<div class="promo"><ul class="bxslider">
  <li><img src="upload/theme/IlluminataNewV2/banner1.JPG"/></li>
  <li><img src="upload/theme/IlluminataNewV2/banner2.JPG" /></li>
  <li><img src="upload/theme/IlluminataNewV2/banner3.JPG" /></li>
        </ul></div></div>
        
            <div class="row icons promo">
                <div class="col-xs-3 icon"><center><img src="upload/theme/IlluminataNewV2/icon1.png"><h3>OUR PRODUCTS</h3><p>We hand pick every pair of glasses and sunglasses from each brand line we carry. We select the most beautiful, interesting and high quality glasses.</p><a href="/ourProducts.html" class="hvr-sweep-to-left">Read more</a></center><br></div>
                <div class="col-xs-3 icon"><center><img src="upload/theme/IlluminataNewV2/icon2.png"><h3>OUR SERVICE</h3><p>Buy eyeglasses and lenses online. Visit us to try them on and get fitted before installing lenses the same day. You can change to a different frame before lenses are installed.</p><a href="/ourService.html" class="hvr-sweep-to-left">Read more</a></center><br></div>
                <div class="col-xs-3 icon"><center><img src="upload/theme/IlluminataNewV2/icon3.png"><h3>EYE EXAMS</h3><p>Book an Eye Exam and choose a new pair of eyeglasses on the same day! Our doctor will perform an eye exam and our optician will help you to pick a frame.</p><a href="/eyeexam.html" class="hvr-sweep-to-left">Read more</a></center><br></div>
                <div class="col-xs-3 icon"><center><img src="upload/theme/IlluminataNewV2/icon4.png"><h3>SHOP ONLINE</h3><p>Huge catalog of eyeglasses and sunglasses of over 40 world best brand names. Pick up your purchase from our store or get it shipped to your home.</p><a href="/shopOnline.html" class="hvr-sweep-to-left">Read more</a></center><br></div>
            </div>
<div id="content" style="margin-top: 420px;">
	...
	<img src="upload/theme/IlluminataNewV2/couponBack.PNG" style="float: right; margin-right:30px;"/>
...
<script src="upload/theme/IlluminataNewV2/bx.js"></script>
</div>
