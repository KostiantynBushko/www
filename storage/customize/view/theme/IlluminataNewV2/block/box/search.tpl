...
<input type="submit" class="submit" style="position: relative; right: 50px; border: none; background-image: url('upload/theme/IlluminataNewV2/searchicon.jpg'); background-position: right; background-repeat: no repeat; background-color: white; color: gray;" value="|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" />
