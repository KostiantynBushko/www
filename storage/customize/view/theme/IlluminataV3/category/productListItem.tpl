		...
		<div class="order">
			<div class="orderingControls">
				...
				{if 'ENABLE_WISHLISTS'|config}
					...
					<a href="{link controller=order action=addToWishList id=$product.ID returnPath=true}" rel="nofollow" class="addToWishListList" style="float:right; font-size: smaller;">Add To Wishlist&nbsp;<img src='upload/theme/IlluminataV3/wishicon.png'></a>
					{assign var=sep value=false}
				{/if}
