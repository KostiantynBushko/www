    ...
    $(".input-types-wrapper a").click(function(){
        ...
        if(this_class=="input-webcam" || this_class=="input-webcam active"){
            ...
            $("#camera").webcam({
                ...
                onCapture: function() {
                    webcam.save('upload.php?action=upload_webcam&id=' + window.webcamID);
                },
                onSave: function(data, data2) {
                    $(".the-face .face").html('<img src="../public/upload/mirror/upload-' + window.sessionID + '.jpg?' + Math.random() + '" alt="">');
                    $(".frame").show();
                },
    ...
    if($("#thumbnail_uploadfiles").length>0) {
        ...
        uploader.bind('FileUploaded', function(up, file, response) {
            ...
            if(s_response.indexOf("Error: ") != -1){
                ...
                var img_src = "../public/upload/mirror/"+file_name;
