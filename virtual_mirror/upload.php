...
$uploadDir = dirname(dirname(__file__)) . '/public/upload/mirror/';
...
switch ($action) {
	...
	case 'upload_webcam':
		$file = "upload-" . session_id() . ".jpg";
		file_put_contents($uploadDir . $file, pack("H*", $HTTP_RAW_POST_DATA ));
		echo $file;
		break;
